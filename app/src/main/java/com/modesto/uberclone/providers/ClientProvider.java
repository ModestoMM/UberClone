...
public class ClientProvider {
    ...
    //Este metodo se utilizara para retiornar la instancia de la base de datos en la clase Client
    //para poderla usar dentro de la clase Map Driver y asi conosca esos datos el driver
    public DatabaseReference getClient(String idClient){
        return mDatabase.child(idClient);
    }

    //CON ESTE METODO ACTUALIZARE LOS CAPOS DEL NOMBRE DEL USUARIO Y EL IMAGE QUE VOY A CREAR EN LA DATABASE
