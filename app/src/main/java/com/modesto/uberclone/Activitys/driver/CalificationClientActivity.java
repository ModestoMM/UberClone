...
import com.modesto.uberclone.Activitys.client.CalificationDriverActivity;
...
public class CalificationClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExtraClientId= getIntent().getStringExtra("id_client");
    ...
    private void getPrice() {
        mClientBookingProvider.getPrice(mExtraClientId).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        if(mCalification > 0){
            ...
            mHistoryBookingProvider.getHistoryBooking(mHistoryBooking.getIdHistoryBooking()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    //de la calificacion del cliente en este caso y si no va a crear todo el historybooking desde el principio
                    if(snapshot.exists()){
